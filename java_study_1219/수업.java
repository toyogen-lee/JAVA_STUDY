...
interface CC{     //인터페이스는 클래스와 다르게 생성자가 없음
	/*
	 * interface
	 * 1. 메소드 선언만 가능 (구현 x)
...
/*
 * 자바는 다중 상속이 불가능합니다.
 * 그래서 다중 상속이 가능하게 하는 '특별한' 기능이 존재
 * implements 는 실무에서 100% 사용합니다.
 */
class BB extends AA implements CC{

	@Override
	public void z() {    //강제로 재정의 해야 함.
	 ...
	 * 반드시 '재정의' 해야 합니다.
	 * 즉, 인터페이스를 구현한 클래스는 '강제' 로 구현해야 합니다.
	 */
